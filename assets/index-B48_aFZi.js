...
`;var h={상품목록_레이아웃_로딩:i,상품목록_레이아웃_로딩완료:a,상품목록_레이아웃_카테고리_1Depth:o,상품목록_레이아웃_카테고리_2Depth:s,토스트:c,장바구니_비어있음:l,장바구니_선택없음:u,장바구니_선택있음:d,상세페이지_로딩:f,상세페이지_로딩완료:p,_404_:m};const g=`/front_6th_chapter1-1/`,_=()=>r(async()=>{let{worker:e}=await import(`./browser-CcyfQrG1.js`);return{worker:e}},[]).then(({worker:e})=>e.start({serviceWorker:{url:`${g}mockServiceWorker.js`},onUnhandledRequest:`bypass`}));function v(){document.body.innerHTML=`
    ${h.상품목록_레이아웃_로딩}
    <br />
    ${h.상품목록_레이아웃_로딩완료}
    <br />
    ${h.상품목록_레이아웃_카테고리_1Depth}
    <br />
    ${h.상품목록_레이아웃_카테고리_2Depth}
    <br />
    ${h.토스트}
    <br />
    ${h.장바구니_비어있음}
